...
export const IS_FAMILYGRAM = import.meta.env.TG_FAMILYGRAM_SELF_HOSTED === '1';

export const APP_CODE_NAME = IS_FAMILYGRAM ? 'FamilyGram' : 'A';
export const APP_ENV = import.meta.env.TG_APP_ENV;
export const APP_NAME = import.meta.env.TG_APP_NAME || (
  IS_FAMILYGRAM ? 'FamilyGram Web' : `Telegram Web ${APP_CODE_NAME}`
);
...
// Testgram negotiates legacy secret-sauce versions (2.7.7); upstream uses 13.0.0 for Telegram cloud.
export const CALL_PROTOCOL_LIBRARY_VERSIONS = IS_FAMILYGRAM
  ? ['4.0.0', '4.0.1', '2.7.7']
  : ['13.0.0'];
